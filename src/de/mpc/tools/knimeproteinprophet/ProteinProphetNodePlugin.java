 ...
 * @author julianu
 */
public class ProteinProphetNodePlugin extends Plugin {
    // The shared instance.
    private static ProteinProphetNodePlugin plugin;

    /**
     * The constructor.
     */
    public ProteinProphetNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ProteinProphetNodePlugin getDefault() {
        return plugin;
    }
